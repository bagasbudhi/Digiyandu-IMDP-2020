...
const char* ssid = "nadjib";
const char* password = "mn030358";

//Backend credentials
const char* mqtt_server = "mqtt.flexiot.xl.co.id";
String DEVICE_SERIAL = "7360319863815521" ; //update the device serial according to the serial given by the consumer portal 
const char* EVENT_TOPIC = "flexiot_esp32_demo/esp3do2_devkit/v1/common";
String SUB_TOPIC_STRING = "+/" + DEVICE_SERIAL + "/flexiot_esp32_demo/esp32_devkit/v1/sub";
const char* mqtt_username = "flexiot_esp32_demo-esp32_devkit-v1_4563";
const char* mqtt_password = "1591083550_4563";
...
//FlexIoT JSON format --> {"eventName":"SensorDHT","status":"<none>","temp":"<Temperature>","humid":"<Humidity>","mac":"<macAddressOfDevice>"}
  ...
  String message = "{\"eventName\":\"SensorDHT\",\"status\":\"none\",\"temp\":" + String(t) + ",\"humid\":" + String(h) + ",\"mac\":\"" + DEVICE_SERIAL + "\"}";
  Serial.println(message);
